...
class _Appoinment extends State<Appoinment>
                                                        ...
                                                        children: <Widget>[
                                                           Container(
                                                              height: 75,
                                                                ...
                                                                EdgeInsets.only(
                                                                    left: 5),
                                                                child: commonCacheImageWidget(upcomingorderdataList[index].salon!.imagePath.toString()+upcomingorderdataList[index].salon!.image.toString(), 75, width: 55,fit: BoxFit.fill)),
                                                                    ...
                                                                    margin: EdgeInsets
                                                                        .only(
                                                                            top:
                                                                                25.0),
                                                                    child: Text(
                                                                      upcomingorderdataList[index].salon!.name.toString(),
                                                                      style: TextStyle(
                                                                          color: Color(
                                                                              0xFF1e1e1e),
                                                                          fontSize:
                                                                    ...
                                                                    margin: EdgeInsets
                                                                        .only(
                                                                            ...
                                                                            left:
                                                                                0.0),
                                                                    child: Text(
                                                                      upcomingorderdataList[index].salon!.address.toString(),
                                                                      overflow:
                                                                          TextOverflow
                                                                              .ellipsis,
                                                                      maxLines: 1,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          margin: EdgeInsets.only(
                                                                              ...
                                                                              left:
                                                                                  2),
                                                                          child: Text(
                                                                              upcomingorderdataList[index].salon!.rate.toString() +
                                                                                  " Rating",
                                                                              style: TextStyle(
                                                          ...
                                                          children: <Widget>[
                                                            Expanded(
                                                              child:
                                                                ...
                                                                child:
                                                                    CachedNetworkImage(
                                                                  imageUrl: canceldataList[index].salon!.imagePath.toString()+canceldataList[index].salon!.image.toString(),
                                                                  imageBuilder:
                                                                      (context,
                                                                              imageProvider) =>
                                                                          Container(
                                                                      ...
                                                                      margin: EdgeInsets
                                                                          .only(
                                                                              top:
                                                                                  25.0),
                                                                      child: Text(
                                                                        canceldataList[index].salon!.name.toString(),
                                                                        style: TextStyle(
                                                                            color: Color(
                                                                                0xFF1e1e1e),
                                                                            fontSize:
                                                                    ...
                                                                    Container(
                                                                      margin: EdgeInsets.only(
                                                                          ...
                                                                          left:
                                                                              0.0),
                                                                      child: Text(
                                                                        canceldataList[index].salon!.address.toString(),
                                                                        overflow:
                                                                            TextOverflow
                                                                                .ellipsis,
                                                                        maxLines:
                                                                        ...
                                                                        Container(
                                                                          child:
                                                                            ...
                                                                            margin: EdgeInsets.only(
                                                                                ...
                                                                                left: 2),
                                                                            child: Text(
                                                                                canceldataList[index].salon!.rate.toString() + " Rating",
                                                          ...
                                                          children: <Widget>[
                                                            Expanded(
                                                              child:
                                                                ...
                                                                child:
                                                                    CachedNetworkImage(
                                                                  imageUrl: completeddataList[index].salon!.imagePath.toString()+completeddataList[index].salon!.image.toString(),
                                                                  imageBuilder:
                                                                      (context,
                                                                              imageProvider) =>
                                                                          Container(
                                                                      ...
                                                                      margin: EdgeInsets
                                                                          .only(
                                                                              top:
                                                                                  25.0),
                                                                      child: Text(
                                                                        completeddataList[index].salon!.name.toString(),
                                                                        style: TextStyle(
                                                                            color: Color(
                                                                                0xFF1e1e1e),
                                                                            fontSize:
                                                                    ...
                                                                    Container(
                                                                      margin: EdgeInsets.only(
                                                                          ...
                                                                          left:
                                                                              0.0),
                                                                      child: Text(
                                                                        completeddataList[index].salon!.address.toString(),
                                                                        overflow:
                                                                            TextOverflow
                                                                                .ellipsis,
                                                                        maxLines:
                                                                        ...
                                                                        Container(
                                                                          child:
                                                                            ...
                                                                            margin: EdgeInsets.only(
                                                                                ...
                                                                                left: 2),
                                                                            child: Text(
                                                                                completeddataList[index].salon!.rate.toString() + " Rating",
                                                                                style: TextStyle(color: const Color(0xFF999999), fontSize: 11, fontWeight: FontWeight.w600, fontFamily: 'Montserrat')),
                                                                          ),
                                                                        ),
                                                                        Container(
                                                                ...
                                                                completeddataList[
                                                                    ...
                                                                    ? InkWell(
                                                                        onTap:
                                                                          ...
                                                                          _newAddReview(
                                                                              context,
                                                                              completeddataList[index].id,completeddataList[index].salon!.salonId.toString());
                                                                        },
                                                                        child:
                                                                            Container(
                                                                          // height: 100.0,
  ...
  void callApiForaddReview(int? id, String message,salonId) {
    print("bookid:$id");
    ...
    RestClient(Retro_Api().Dio_Data())
        .addreview(message, rating.toString(), id.toString(),salonId)
        .then((response) {
      setState(() {
        _loading = false;
  ...
  void _newAddReview(BuildContext context, int? id,String salonId) {
    dynamic screenHeight = MediaQuery.of(context).size.height;
    dynamic screenwidth = MediaQuery.of(context).size.width;
    double height = 900.0;
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  if (rating != 0.0) {
                                    AppConstant.CheckNetwork().whenComplete(
                                        () => callApiForaddReview(
                                            id, reviewTextController.text,salonId));
