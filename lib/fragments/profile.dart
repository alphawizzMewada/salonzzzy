...
import 'package:barber/drawerscreen/top_offers.dart';
import 'package:barber/fragments/editprofile.dart';
                                                                    ...
                                                                    children: <Widget>[
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              CachedNetworkImage(
                                                                            imageUrl: upcomingorderdataList[index].salon!.imagePath.toString()+upcomingorderdataList[index].salon!.image.toString(),
                                                                            imageBuilder:
                                                                                (context,
                                                                                        imageProvider) =>
                                                                                    Container(
                                                                                ...
                                                                                children: <
                                                                                  ...
                                                                                  Container(
                                                                                    child:
                                                                                      ...
                                                                                      child:
                                                                                          Text(upcomingorderdataList[index].salon!.rate.toString() + " Rating", style: TextStyle(color: const Color(0xFF999999), fontSize: 11, fontWeight: FontWeight.w600, fontFamily: 'Montserrat')),
                                                                                    ),
                                                                                  ),
                                                                                  Container(
                                                                                    alignment:
