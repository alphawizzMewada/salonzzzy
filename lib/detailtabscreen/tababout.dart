...
class _TabAbout extends State<TabAbout> {
  ...
  void initState() {
    ...
    canLaunchUrl(Uri(scheme: 'tel', path: '${widget.salonData.phone.toString()}')).then((bool result) {
      setState(() {
    ...
    if (widget.salonData != null) {
      if (mounted) {
        setState(() {
          double salon_lat = widget.salonData.latitude.toString() != null
              ? double.parse(widget.salonData.latitude)
              : 22.336346;
          double salon_long = widget.salonData.longitude.toString() != null
              ? double.parse(widget.salonData.longitude)
              : 72.78757;
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            _makePhoneCall(widget.salonData.phone.toString());
                          },
                          child: Container(
                            child: Text(
