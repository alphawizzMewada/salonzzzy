                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    if (connectivityResult ==
                                      ...
                                      if(_password != null && _password.toString().length == 8){
                                        ...
                                        toastMessage("Please enter 8 digit password");
                                      }
    ...
    RestClient(Retro_Api().Dio_Data())
      ...
      switch (obj.runtimeType) {
        case DioError:
          ...
          var emailAndPhoneCheckMap ;
          if(res.data['errors'] != null ){
            emailAndPhoneCheckMap = res.data['errors'];
          }
          var emailErrorMessage, phoneErrorMessage ;
          if(emailAndPhoneCheckMap != null && emailAndPhoneCheckMap['email'] != null){
             emailErrorMessage = emailAndPhoneCheckMap['email'];
          }else if(emailAndPhoneCheckMap != null && emailAndPhoneCheckMap['phone'] != null){
            phoneErrorMessage = emailAndPhoneCheckMap['phone'];
          }
          if(emailErrorMessage != null){
            toastMessage("$emailErrorMessage");
          }else if(phoneErrorMessage != null ) {
            toastMessage("$phoneErrorMessage");
          }
