...
class Data {
  ...
  Data({this.salon, this.gallery, this.category, this.review, this.video});
...
class Salon {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['name'] = this.name;
    data['free_unfree'] = this.freeUnfree;
...
class Video {
  ...
  Video({this.galleryId, this.image, this.imagePath});
